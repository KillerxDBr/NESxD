...
# Program
$(OUT): $(FULLOBJ) $(OBJDIR)main.h.gch $(OBJDIR)6502.h.gch $(OBJDIR)input.h.gch
...
$(OBJDIR)main.h.gch: $(SRCDIR)main.h
	$(CC) -xc-header -o$(OBJDIR)main.h.gch $(SRCDIR)main.h

$(OBJDIR)6502.h.gch: $(SRCDIR)6502.h
	$(CC) -xc-header -o$(OBJDIR)6502.h.gch $(SRCDIR)6502.h

$(OBJDIR)input.h.gch: $(SRCDIR)input.h
	$(CC) -xc-header -o$(OBJDIR)input.h.gch $(SRCDIR)input.h
